...
function insertNewPost(price, city, condition, photoURL, description) {
...
function handleModalAcceptClick() {
  ...
  if (!price || !city || !condition || !photoURL || !description) {
...
function doFilterUpdate() {
  ...
  allPosts.forEach(function (post) {
    if (postPassesFilters(post, filters)) {
      insertNewPost(post.price, post.city, post.condition, post.photoURL, post.description);
    }
  });
}
